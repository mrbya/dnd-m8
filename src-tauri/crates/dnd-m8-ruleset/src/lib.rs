//! Public contracts implemented by D&D Mate ruleset crates.
//!
//! This crate defines the boundary shared by the application and concrete
//! ruleset implementations. It deliberately owns no Tauri, persistence, or
//! user-interface concerns and never depends on a concrete ruleset.
